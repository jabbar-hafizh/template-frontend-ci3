...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-12 mb-4">
      <h3 class="mb-4 text-gray-800">Dashboard Monitoring & Evaluasi Kinerja Badan Pengawasan 
        <div class="mb-4 btn-group float-right">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in p-2" aria-labelledby="dropdownTahun">
              <h6 class="dropdown-header text-primary">Tahun</h6>
          ...
          <div class="dropdown ml-2">
            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownPeriode"
              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Periode
            </button>
            <div class="dropdown-menu animated--fade-in p-2" aria-labelledby="dropdownPeriode">
              <h6 class="dropdown-header text-primary">Triwulan</h6>
              <a class="dropdown-item" href="#">Triwulan I</a>
              <a class="dropdown-item" href="#">Triwulan II</a>
              <a class="dropdown-item" href="#">Triwulan III</a>
              <a class="dropdown-item" href="#">Triwulan IV</a>
              <h6 class="dropdown-header text-primary">Semester</h6>
              <a class="dropdown-item" href="#">Semester I</a>
              <a class="dropdown-item" href="#">Semester II</a>
            </div>
          </div>
        </div>
      </h3>
      <div class="card-header bg-gradient-primary"; style= "border-radius: calc(0.35rem - 1px) calc(0.35rem - 1px) calc(0.35rem - 1px) calc(0.35rem - 1px)">
        <h5 style="color: white; display: flex; align-items: center; justify-content: center;">INDIKATOR KINERJA INSPEKTUR WILAYAH III - BADAN PENGAWASAN</h5>
      </div>
    </div>
        ...
        <div class="card shadow mb-4">
          ...
          <div class="collapse" id="collapseCardExample2">
            <div class="card-body text-gray-900">
              ...
              <h7 class="large font-weight-bold">Jumlah Pedoman Pengawasan<span class="float-right">Target : 1 Pedoman</span></h7>
